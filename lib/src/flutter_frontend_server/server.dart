...
import 'package:frontend_server/frontend_server.dart' as frontend
    show
        ...
        usage,
        ProgramTransformer;
import 'package:ft/src/transformer/aop_transformer.dart';
...
class _FlutterFrontendCompiler implements frontend.CompilerInterface {
  ...
  final FtTransformer _ftTransformer = FtTransformer();
  ...
  Future<bool> compile(String filename, ArgResults options,
    ...
    if (!transformers.contains(_ftTransformer)) {
      transformers.add(_ftTransformer);
    }
